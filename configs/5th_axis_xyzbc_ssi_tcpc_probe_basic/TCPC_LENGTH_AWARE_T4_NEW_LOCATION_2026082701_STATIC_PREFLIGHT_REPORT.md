# TCPC Length-Aware T4 New-Location Static Preflight
...
- parser: deferred; validate by loading this exact file in the already-running dedicated controller
- controller-process gate: LinuxCNC may remain active; standalone rs274 was deliberately not launched
...
- `nc_files/calibration/tcpc_length_aware_t4_new_location_2026082701_attempt1.ngc`: `54bd1e3b5cfc95f44ddbf344693652b68dec920f74649e466d939860fe4a9174`
...
- validator: `9db1e30180aaa1357c12460d680b6687ce148c03a03b90d07e60c9a5da0f9d55`
...
| --- | ---: | --- |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-results.csv` | 33 | `9785983d8f89a4955082aa04d8a9e16bf2e2bdc00caccb4cd19f66e545416e93` |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-state.csv` | 35 | `ac9e7ddd425e187444dd4ee339466a8e1713ca6e7104ccc76eba6076281427c7` |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-model-state.csv` | 22 | `340cdd51e2507d7fbd41c8d4afdef911e83d3e5b4d3354d5fb84a83a7ea428cd` |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-closures.csv` | 15 | `1f2e125d08ab2a0ea5d2210577c4a593f8cea1fc8cc348f67e3ed2a4a987437f` |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-contact-trace.csv` | 32 | `df95e36f729b7bc1e1cef54bf4490ef8530f2e74d52e50671a4c452062c6bbe8` |
| `tcpc-length-aware-t4-new-location-2026082701-attempt1-gap-trace.csv` | 24 | `e8e24f1617d5eb0bf637bdadc42f052d7e96130e808761ab07410cdb85e0d6e2` |
