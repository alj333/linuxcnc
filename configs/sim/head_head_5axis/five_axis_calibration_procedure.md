# Superseded Head-Head Calibration Procedure

Status: historical pre-calibration plan

The former wizard-oriented 20 mm sphere procedure has been superseded by the
completed certified ring/sphere campaigns and the frozen length-aware model
revision `2026082601`. The filename remains to keep old references readable,
but it is no longer an operator procedure.
...
`2026082601` remains the shared frozen source for both public modes.
