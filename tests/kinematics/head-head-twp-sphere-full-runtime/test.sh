...
PASS_CSV=/home/cnc5/linuxcnc-dev/configs/5th_axis_xyzbc_ssi_tcpc_probe_basic/twp-sphere-stage1-t4-passes.csv
RESULT_CSV=/home/cnc5/linuxcnc-dev/configs/5th_axis_xyzbc_ssi_tcpc_probe_basic/twp-sphere-stage1-t4-results.csv
BACKUP_DIR=
...
preflight || exit $?
BACKUP_DIR=$(mktemp -d /tmp/twp-sphere-full-runtime.XXXXXX) || exit 99
