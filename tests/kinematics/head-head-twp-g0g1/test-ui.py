...
wait_for_pause(
    ...
    e,
    "first TWP move",
    (1500.0, 956.066, -706.066, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 0.0, True)
log("pause 4 ok")
...
wait_for_pause(
    ...
    e,
    "second TWP move",
    (1400.0, 956.066, -706.066, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 0.0, True)
log("pause 5 ok")
...
wait_for_pause(
    ...
    e,
    "third TWP move",
    (1400.0, 991.421, -670.711, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 0.0, True)
log("pause 6 ok")
...
wait_for_pause(
    s,
    e,
    "rotated TWP active pose",
    (1500.0, 850.0, -600.0, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 90.0, True)
log("pause 9 ok")
...
wait_for_pause(
    s,
    e,
    "first rotated TWP move",
    (1350.0, 850.0, -600.0, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 90.0, True)
log("pause 10 ok")
...
wait_for_pause(
    s,
    e,
    "second rotated TWP move",
    (1350.0, 779.289, -529.289, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 90.0, True)
log("pause 11 ok")
...
wait_for_pause(
    s,
    e,
    "third rotated TWP move",
    (1350.0, 814.645, -493.934, 45.0, 90.0),
)
assert_twp_state(True, True, 3, True, 90.0, True)
log("pause 12 ok")
...
wait_for_pause(
    s,
    e,
    "rotated TWP cancelled world pose",
    (1350.0, 814.645, -493.934, 45.0, 90.0),
)
assert_twp_state(False, False, 0, False, 0.0, True)
log("pause 13 ok")
...
wait_for_pause(
    s,
    e,
    "TCPC disabled final world pose",
    (1350.0, 814.645, -493.934, 45.0, 90.0),
)
assert_twp_state(False, False, 0, False, 0.0, False)
log("pause 14 ok")
