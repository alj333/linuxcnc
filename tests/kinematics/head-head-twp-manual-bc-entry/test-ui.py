...
ui = hal.component("test-ui-manual-bc")
ui.ready()
...
wait_for_pause(
    s,
    e,
    "first TWP move from manual BC entry",
...
wait_for_pause(
    s,
    e,
    "second manual BC move after G69",
    (1500.0, 850.0, -600.0, 30.0, 45.0),
)
assert_twp_state(False, False, 0, False, 0.0, True)
log("pause 7 ok")
...
wait_for_pause(
    s,
    e,
    "second TWP entered from current BC",
    (1500.0, 850.0, -600.0, 30.0, 45.0),
)
assert_twp_state(True, True, 3, True, 0.0, True)
log("pause 8 ok")
...
wait_for_pause(
    s,
    e,
    "second TWP move from manual BC entry",
    (1561.237, 911.237, -650.0, 30.0, 45.0),
)
assert_twp_state(True, True, 3, True, 0.0, True)
log("pause 9 ok")
